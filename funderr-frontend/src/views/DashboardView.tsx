...
import type { ProposalDetailView, Beneficiary, Property, CreditLine } from "../domain/types";
...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  return (
    <div className="space-y-6">
      {/* Top Banner / Welcome */}
      <div className="bg-blue-100 rounded-[28px] p-6 text-blue-900 border border-blue-200 relative overflow-hidden">
        <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-2 bg-blue-200 text-blue-900 text-xs px-3 py-1 rounded-full mb-2">
              <span>🌾 Painel Integrado de Crédito Rural</span>
            </div>
            <h2 className="text-2xl font-bold tracking-tight">
              Gestão de Propostas e Assistência Técnica FUNDERR
            </h2>
            <p className="text-sm text-blue-900/75 mt-1 max-w-2xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-surface p-5 rounded-xl border border-slate-200 shadow-xs flex items-center justify-between">
          <div>
      ...
      <div className="bg-surface rounded-xl border border-slate-200 shadow-xs overflow-hidden">
        <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
          ...
          <AppButton
            ...
            className="text-xs font-semibold text-[#386a20] hover:underline flex items-center gap-1"
          >
                  ...
                  <tr key={p.proposal.id} className="hover:bg-slate-50/80 transition-colors">
                    ...
                    <td className="px-6 py-3.5 text-right">
                      <AppButton
                        ...
                        className="text-xs font-bold bg-slate-100 hover:bg-blue-50 text-slate-700 hover:text-[#386a20] px-2.5 py-1 rounded-md border border-slate-200"
                      >
                        Abrir Esteira
                      </AppButton>
                    </td>
